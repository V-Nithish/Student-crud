    ...
    <div className="container-fluid">
      ...
      >
        ...
        <ul className="nav flex-column mt-4">
          ...
          <li className="nav-item">
            <Link className="nav-link text-white" to="/register">ADD STUDENT</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-white" to="/viewstudents">VIEW STUDENT</Link>
          </li>
          <li className="nav-item">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card h-100 shadow-sm">
              <div className="card-body text-center">
                <h5 className="card-title">ADDING STUDENT</h5>
           ...
           <div className="col-md-6 col-lg-4">
            <div className="card h-100 shadow-sm">
              <div className="card-body text-center">
                ...
                <p className="card-text">Manage Admin details</p>
                <Link to="/viewadmins" className="btn btn-secondary">Manage</Link>
              </div>
            </div>
          </div>
        </div>
